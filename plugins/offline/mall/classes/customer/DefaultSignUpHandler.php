...
class DefaultSignUpHandler implements SignUpHandler
{
    ...
    public static function rules($forSignup = true): array
    {
        ...
        $rules = [
            ...
            'billing_country_id'  => 'required|exists:winter_location_countries,id',
            'billing_state_id'    => 'required|exists:winter_location_states,id',
            ...
            'shipping_state_id'   => 'required_if:use_different_shipping,1|exists:winter_location_states,id',
            'shipping_country_id' => 'required_if:use_different_shipping,1|exists:winter_location_countries,id',
